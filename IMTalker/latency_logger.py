...
MARK_LABELS: dict[str, str] = {
    ...
    "audio_playback_start":   "first reply audio actually written to websocket (server send)",
    "avatar_first_frame":     "first avatar video frame sent to browser",
    # -- real client-side playback marks ------------------------------------
    "server_audio_send":          "first audio packet written to websocket (server send)",
...
CLIENT_INTERVALS: list[tuple[str, str]] = [
    ...
    ("user_end_to_actual_playback_s", "User speech end -> actual playback [*]"),
]
